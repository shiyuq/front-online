<template>
  <div class="header-report">
    <div class="header-report__container">
      <div class="report-header">
        <h1>最新报道</h1>
        <div class="report-header__more-news">
          <span class="more-text">更多新闻</span>
  ...
  data () {
    return {
      newsList: [
        {
          id: 0,
          imgUrl: 'https://shiyuq.oss-cn-shanghai.aliyuncs.com/hide-on-bush/assets/home/report/report1.jpg',
          date: moment().add(-2, 'day').format('YYYY年MM月DD日'),
          title: '香港蚂蚁银行正式营业'
        },
        {
          id: 1,
          imgUrl: 'https://shiyuq.oss-cn-shanghai.aliyuncs.com/hide-on-bush/assets/home/report/report2.jpg',
